...
const schema = z.object({
  agencySlug: z.string().trim().min(1, "Indiquez le code de l'agence"),
...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-surface p-6">
      <Card className="w-full max-w-sm bg-bg p-6">
        <div className="mb-6">
          <h1 className="text-title font-semibold">LaGestion</h1>
          <p className="mt-1 text-base text-secondary">Back-office</p>
        </div>
